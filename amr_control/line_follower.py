...
class LineFollower(object):
    ...
    def camera_callback(self, data):
        ...
        if self.process_this_frame:
            ...
            if cv_image is not None:
                ...
                deltaX= (mid4[1]-width/2.0)

                rospy.loginfo("mid[1]=%s" % (str(mid[1])))
    ...
    def move_robot(self, image_dim_y, image_dim_x, slope, deltaX, linear_vel_base = 0.07, lineal_vel_min= 0.23, angular_vel_base = 0.075, movement_time = 0.05):
        ...
        FACTOR_LINEAR = 0.0005
        FACTOR_ANGULAR = 0.01

        delta_left_percentage_not_important = 0.005
        min_lin = 0.26
        min_ang = 0.7
        ...
        if  deltaX is not None:
            ...
            cmd_vel.linear.x = linear_vel_base + abs(delta[0]) * FACTOR_LINEAR
